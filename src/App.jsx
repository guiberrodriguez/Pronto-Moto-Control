  ...
  return (
    <div className="app">
      ...
      <div className="card">
        ...
        <div style={{background:"#eee",borderRadius:10,overflow:"hidden",height:18}}>
          <div style={{width:`${Math.min(100,(motosMorosas.length/(motos.length || 1))*100)}%`,background:"#25D366",height:18}}></div>
        </div>
      </div>
      ...
      {tab==="inicio" && (
        <div className="card">
          ...
          <p>Esta versión está preparada para PWA/APK instalable.</p>
        </div>
      )}
      ...
      {tab==="clientes" && (
        <div className="card">
          ...
          <input 
            placeholder="Buscar cliente por nombre, ID, cédula, teléfono, correo, país..."
        ...
        <div className="card">
          ...
          {clientePago && (
            <div className="item">
              ...
              <p><b>Correo:</b> {clientePago.correo}</p>
            </div>
          )}
          ...
          {ultimo && (
            <div className="item">
              ...
              <p><b>Cuotas pendientes:</b> {ultimo.cuotasPendientes}</p>
              <p><b>Pendiente antes:</b> {money(ultimo.montoPendienteAntes)}</p>
              <p><b>Monto pagado:</b> {money(ultimo.monto)}</p>
              <p><b>Pendiente después:</b> {money(ultimo.montoPendienteDespues)}</p>
              <p><b>Estatus:</b> {ultimo.estatus}</p>
          ...
          {pagos.map(p=>(
            <div className="item" key={p.docId}>
              ...
              <p>Pendiente después: {money(p.montoPendienteDespues || 0)}</p>
